...
-- 以下 cultural_region / modern_country 是地图定位代理，不表示边界内人口同质，
-- 也不把现代国界倒推为历史时期的政治疆界。
('central_europe','cultural_region',NULL,NULL,'中欧历史空间代理'),
('eastern_europe','cultural_region',NULL,NULL,'东欧历史空间代理'),
('north_sea_coast','cultural_region',NULL,NULL,'北海南岸及日德兰历史空间代理'),
('ireland_and_scotland','cultural_region',NULL,NULL,'爱尔兰与苏格兰盖尔文化空间代理'),
('lower_danube','cultural_region',NULL,NULL,'多瑙河下游历史空间代理'),
('england','cultural_region',NULL,NULL,'英格兰现代空间代理'),
('scotland','cultural_region',NULL,NULL,'苏格兰现代空间代理'),
('wales','cultural_region',NULL,NULL,'威尔士现代空间代理'),
('ireland','modern_country',NULL,NULL,'爱尔兰现代国界空间代理'),
('france','modern_country',NULL,NULL,'法国现代国界空间代理'),
('germany','modern_country',NULL,NULL,'德国现代国界空间代理'),
('netherlands','modern_country',NULL,NULL,'荷兰现代国界空间代理'),
('denmark','modern_country',NULL,NULL,'丹麦现代国界空间代理'),
('sweden','modern_country',NULL,NULL,'瑞典现代国界空间代理'),
('norway','modern_country',NULL,NULL,'挪威现代国界空间代理'),
('spain','modern_country',NULL,NULL,'西班牙现代国界空间代理'),
('portugal','modern_country',NULL,NULL,'葡萄牙现代国界空间代理'),
('romania','modern_country',NULL,NULL,'罗马尼亚现代国界空间代理'),
('poland','modern_country',NULL,NULL,'波兰现代国界空间代理'),
('czechia','modern_country',NULL,NULL,'捷克现代国界空间代理'),
('slovakia','modern_country',NULL,NULL,'斯洛伐克现代国界空间代理'),
('serbia','modern_country',NULL,NULL,'塞尔维亚现代国界空间代理'),
('croatia','modern_country',NULL,NULL,'克罗地亚现代国界空间代理'),
('slovenia','modern_country',NULL,NULL,'斯洛文尼亚现代国界空间代理'),
('bulgaria','modern_country',NULL,NULL,'保加利亚现代国界空间代理'),
('greece','modern_country',NULL,NULL,'希腊现代国界空间代理'),
('albania','modern_country',NULL,NULL,'阿尔巴尼亚现代国界空间代理'),
('hungary','modern_country',NULL,NULL,'匈牙利现代国界空间代理'),
('ukraine','modern_country',NULL,NULL,'乌克兰现代国界空间代理'),
('belarus','modern_country',NULL,NULL,'白俄罗斯现代国界空间代理'),
('russia','modern_country',NULL,NULL,'俄罗斯现代国界空间代理；地图数据展示欧洲部分'),
('latvia','modern_country',NULL,NULL,'拉脱维亚现代国界空间代理'),
('lithuania','modern_country',NULL,NULL,'立陶宛现代国界空间代理'),
('estonia','modern_country',NULL,NULL,'爱沙尼亚现代国界空间代理'),
('finland','modern_country',NULL,NULL,'芬兰现代国界空间代理'),
('georgia','modern_country',NULL,NULL,'格鲁吉亚现代国界空间代理'),
('armenia','modern_country',NULL,NULL,'亚美尼亚现代国界空间代理'),
('azerbaijan','modern_country',NULL,NULL,'阿塞拜疆现代国界空间代理');
...
('central_europe','en','Central Europe'),('central_europe','zh','中欧'),
('eastern_europe','en','Eastern Europe'),('eastern_europe','zh','东欧'),
('north_sea_coast','en','North Sea coast and Jutland'),('north_sea_coast','zh','北海沿岸与日德兰'),
('ireland_and_scotland','en','Ireland and Gaelic Scotland'),('ireland_and_scotland','zh','爱尔兰与盖尔苏格兰'),
('lower_danube','en','Lower Danube'),('lower_danube','zh','多瑙河下游'),
('england','en','England'),('england','zh','英格兰'),
('scotland','en','Scotland'),('scotland','zh','苏格兰'),
('wales','en','Wales'),('wales','zh','威尔士'),
('ireland','en','Ireland'),('ireland','zh','爱尔兰'),
('france','en','France'),('france','zh','法国'),
('germany','en','Germany'),('germany','zh','德国'),
('netherlands','en','Netherlands'),('netherlands','zh','荷兰'),
('denmark','en','Denmark'),('denmark','zh','丹麦'),
('sweden','en','Sweden'),('sweden','zh','瑞典'),
('norway','en','Norway'),('norway','zh','挪威'),
('spain','en','Spain'),('spain','zh','西班牙'),
('portugal','en','Portugal'),('portugal','zh','葡萄牙'),
('romania','en','Romania'),('romania','zh','罗马尼亚'),
('poland','en','Poland'),('poland','zh','波兰'),
('czechia','en','Czechia'),('czechia','zh','捷克'),
('slovakia','en','Slovakia'),('slovakia','zh','斯洛伐克'),
('serbia','en','Serbia'),('serbia','zh','塞尔维亚'),
('croatia','en','Croatia'),('croatia','zh','克罗地亚'),
('slovenia','en','Slovenia'),('slovenia','zh','斯洛文尼亚'),
('bulgaria','en','Bulgaria'),('bulgaria','zh','保加利亚'),
('greece','en','Greece'),('greece','zh','希腊'),
('albania','en','Albania'),('albania','zh','阿尔巴尼亚'),
('hungary','en','Hungary'),('hungary','zh','匈牙利'),
('ukraine','en','Ukraine'),('ukraine','zh','乌克兰'),
('belarus','en','Belarus'),('belarus','zh','白俄罗斯'),
('russia','en','Russia'),('russia','zh','俄罗斯'),
('latvia','en','Latvia'),('latvia','zh','拉脱维亚'),
('lithuania','en','Lithuania'),('lithuania','zh','立陶宛'),
('estonia','en','Estonia'),('estonia','zh','爱沙尼亚'),
('finland','en','Finland'),('finland','zh','芬兰'),
('georgia','en','Georgia'),('georgia','zh','格鲁吉亚'),
('armenia','en','Armenia'),('armenia','zh','亚美尼亚'),
('azerbaijan','en','Azerbaijan'),('azerbaijan','zh','阿塞拜疆')
) x(code,lang,name)
ON r.code=x.code;
...
-- 每个族群在 people.start_year..people.end_year（NULL 表示至今）内至少有一条
-- 连续空间覆盖。现代国界与粗粒度历史区域仅作可视化代理；不表示排他领土、
-- 人口同质或精确边界。迁徙转折年允许相邻区间在边界年重叠。
INSERT INTO people_region
(people_id, region_id, presence_code, start_year, end_year, confidence_code, render_priority, notes)
SELECT p.id, r.id, v.presence, v.sy, v.ey, v.conf, v.rp,
       CASE WHEN p.people_type='modern'
            THEN '现代国家或构成国边界空间代理；不表示人口同质或排他领土。'
            ELSE 'MVP 粗粒度历史空间近似；边界与转折年代存在不确定性。' END
FROM (VALUES
('goths','eastern_europe','homeland',100,375,'low',60),
('goths','balkans','migration',375,700,'low',40),
('visigoths','balkans','homeland',300,400,'medium',60),
('visigoths','iberian_peninsula','settlement',400,700,'high',50),
('visigoths','gaul','settlement',400,500,'high',50),
('ostrogoths','eastern_europe','homeland',300,493,'low',60),
('ostrogoths','italy','political_control',493,550,'high',90),
('vandals','central_europe','homeland',200,406,'low',60),
('vandals','iberian_peninsula','migration',406,435,'medium',40),
('vandals','north_africa','political_control',435,550,'high',90),
('franks','gaul','settlement',200,900,'medium',50),
('angles','north_sea_coast','homeland',300,450,'low',60),
('angles','britannia','settlement',450,900,'high',50),
('saxons','north_sea_coast','homeland',300,450,'low',60),
('saxons','britannia','settlement',450,1000,'high',50),
('jutes','north_sea_coast','homeland',300,450,'low',60),
('jutes','britannia','settlement',450,800,'high',50),
('gauls','gaul','homeland',-500,500,'medium',60),
('britons','britannia','homeland',-100,800,'medium',60),
('gaels','ireland_and_scotland','homeland',-100,1500,'medium',60),
('burgundians','central_europe','homeland',200,407,'low',60),
('burgundians','gaul','settlement',407,600,'medium',50),
('lombards','central_europe','homeland',200,568,'low',60),
('lombards','italy','political_control',568,1000,'medium',90),
('suebi','central_europe','homeland',100,409,'low',60),
('suebi','iberian_peninsula','settlement',409,600,'medium',50),
('romans','italy','homeland',-500,-27,'medium',60),
('romans','roman_empire','political_control',-27,476,'medium',90),
('romans','italy','settlement',476,600,'low',50),
('latins','italy','homeland',-800,500,'medium',60),
('iberians','iberian_peninsula','homeland',-1000,100,'medium',60),
('celtiberians','iberian_peninsula','homeland',-500,100,'medium',60),
('lusitanians','iberian_peninsula','homeland',-500,100,'medium',60),
('dacians','lower_danube','homeland',-500,300,'medium',60),
('illyrians','balkans','homeland',-1000,100,'low',60),
('thracians','balkans','homeland',-1000,500,'low',60),
('slavs','eastern_europe','homeland',400,1000,'low',60),
('magyars','carpathian_basin','homeland',800,1100,'medium',60),
('english','england','homeland',1000,NULL,'medium',70),
('scots','scotland','homeland',1000,NULL,'medium',70),
('welsh','wales','homeland',700,NULL,'medium',70),
('irish','ireland','homeland',700,NULL,'medium',70),
('french','france','homeland',1000,NULL,'medium',70),
('germans','germany','homeland',1000,NULL,'medium',70),
('dutch','netherlands','homeland',1000,NULL,'medium',70),
('danes','denmark','homeland',900,NULL,'medium',70),
('swedes','sweden','homeland',900,NULL,'medium',70),
('norwegians','norway','homeland',900,NULL,'medium',70),
('italians','italy','homeland',1200,NULL,'medium',70),
('spaniards','spain','homeland',1200,NULL,'medium',70),
('portuguese','portugal','homeland',1200,NULL,'medium',70),
('romanians','romania','homeland',1000,NULL,'medium',70),
('poles','poland','homeland',1000,NULL,'medium',70),
('czechs','czechia','homeland',1000,NULL,'medium',70),
('slovaks','slovakia','homeland',1000,NULL,'medium',70),
('serbs','serbia','homeland',700,NULL,'medium',70),
('croats','croatia','homeland',700,NULL,'medium',70),
('slovenes','slovenia','homeland',700,NULL,'medium',70),
('bulgarians','bulgaria','homeland',700,NULL,'medium',70),
('greeks','greece','homeland',700,NULL,'medium',70),
('albanians','albania','homeland',1000,NULL,'medium',70),
('hungarians','hungary','homeland',1000,NULL,'medium',70),
('ukrainians','ukraine','homeland',1000,NULL,'medium',70),
('belarusians','belarus','homeland',1000,NULL,'medium',70),
('russians','russia','homeland',1000,NULL,'medium',70),
('latvians','latvia','homeland',1000,NULL,'medium',70),
('lithuanians','lithuania','homeland',1000,NULL,'medium',70),
('estonian','estonia','homeland',1000,NULL,'medium',70),
('finns','finland','homeland',1000,NULL,'medium',70),
('georgians','georgia','homeland',1000,NULL,'medium',70),
('armenians','armenia','homeland',500,NULL,'medium',70),
('azerbaijanis','azerbaijan','homeland',1000,NULL,'medium',70)
